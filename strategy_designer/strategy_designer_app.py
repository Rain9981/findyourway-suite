...
def run():
    st.title("AI-Enhanced Tool: " + "strategy_designer".replace("_", " ").title())
    ...
    try:
        save_data(st.session_state.get("user_role", "guest"), locals(), sheet_tab="strategy_designer".title().replace("_", " "))
