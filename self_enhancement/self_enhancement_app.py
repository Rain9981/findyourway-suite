...
def run():
    ...
    if st.button("💡 Generate Insight"):
        ...
        try:
            ...
            text.textLine("Self Enhancement Reflection")
            ...
            pdf.save()
            buffer.seek(0)
            st.download_button("📄 Download Reflection PDF", buffer, file_name="reflection.pdf")
    ...
    if st.button("🔁 Get Future Self Response"):
        ...
        try:
            ...
            pdf.setFont("Helvetica", 12)
            text = pdf.beginText(50, 750)
            text.textLine("Message from Your Future Self")
            text.moveCursor(0, 15)
            ...
            pdf.save()
            buffer.seek(0)
            st.download_button("📄 Download Future Self PDF", buffer, file_name="future_self.pdf")
