...
def run():
    st.title("AI-Enhanced Tool: " + "brand_positioning".replace("_", " ").title())
    ...
    try:
        save_data(st.session_state.get("user_role", "guest"), locals(), sheet_tab="brand_positioning".title().replace("_", " "))
